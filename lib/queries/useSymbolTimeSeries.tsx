...
const convertMeasure = (measure: Measure) => {
  ...
  switch (measure) {
    case "1d":
      option = { measure: "minute", multiplier: 1, delta: 60 * 24 };
      break;
    case "5d":
      option = { measure: "minute", multiplier: 5, delta: 60 * 24 * 5 };
      break;
    case "1m":
      option = { measure: "hour", multiplier: 1, delta: 24 * 30 };
      break;
    case "3m":
      option = { measure: "hour", multiplier: 1, delta: 24 * 30 * 3 };
      break;
    case "6m":
      option = { measure: "day", multiplier: 1, delta: 30 * 6 };
      break;
    case "1y":
      option = { measure: "day", multiplier: 1, delta: 365 };
      break;
    case "5y":
      option = { measure: "week", multiplier: 1, delta: 52 * 5 };
      break;
  }
  return option;
};
